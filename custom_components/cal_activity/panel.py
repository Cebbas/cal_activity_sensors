"""Registers the Cal Activity Sensors sidebar panel and its static JS file."""
    ...
    frontend.async_register_built_in_panel(
        ...
        config={
            "_panel_custom": {
                ...
                "embed_iframe": False,
                "trust_external": True,
                "js_url": f"{_STATIC_URL}/cal-activity-panel.js?v=1",
            }
        },
        require_admin=True,
    )
