...
source failure transitions - not a hot path), so the simplicity of not
having to hook into each entry's setup/unload lifecycle is worth more than
the small amount of extra I/O.
"""
